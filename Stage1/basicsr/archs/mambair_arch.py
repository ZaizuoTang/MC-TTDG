...
class MambaIR(nn.Module):
    ...
    def forward_features(self, x):
        ...
        #     #先保存第0层的特征
        #     Save_root = "/home/tangzz/Code/TTDG/MambaIR-main/Feature_saveroot/0/P"
        #     Save_path = Save_root + os.sep + str(self.Count) + ".npy"
        #     self.Count += 1

        #     x_save = x.cpu().detach().numpy()
        #     np.save(Save_path, x_save)
    ...
    def forward(self, x):
        ...
        #主干网络的第一二层，主干网络的最后一层，网络预测头部的最后一层
